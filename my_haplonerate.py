...
#seqdirectory = "/scratch/mskset001/Mike_files_imbricata/trimmed/alleles_workflow/renamed_genes/{}".format(prefix)
#os.chdir(prefix)
#os.chdir(seqdirectory)
...
#geneList = set([x.rstrip() for x in open("/scratch/mskset001/Mike_files_imbricata/trimmed/alleles_workflow/renamed_genes/genelist.txt")])
...
def main():
    ...
    if args.reference:
        print('Haplonerating using {}'.format(args.reference))
